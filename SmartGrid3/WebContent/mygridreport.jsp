...
<font id="head1" name="head1" face="san-serif" color="#333" size="3"><b>My Grid Report</b></font>
</div>



<div style="margin-left: 2%;margin-top: 2%;" align="left">
<a href="NewPanelBuilder.jsp"><b>Add Grid</b></a>
</div>

<div class="form" style="margin-left: 2%;margin-top: 2%;">

<table id="example" class="display" style="width:100%" cellspacing="0" border-collapse:"collapse" >
        <thead>
            <tr>
            	...
            	<th style="font-size: 14px ; face:san-serif; border: 1px solid #ddd; padding: 8px;padding-top: 12px;padding-bottom: 12px; text-align: left; background-color: #424658; color: white;"><b>User</b></th>
            	<th style="font-size: 14px ; face:san-serif; border: 1px solid #ddd; padding: 8px;padding-top: 12px;padding-bottom: 12px; text-align: left; background-color: #424658; color: white;"><b>Grid</b></th>
                ...
                <th style="font-size: 14px ; face:san-serif; border: 1px solid #ddd; padding: 8px;padding-top: 12px;padding-bottom: 12px; text-align: left; background-color: #424658; color: white;"><b>Row</b></th>
                <th style="font-size: 14px ; face:san-serif; border: 1px solid #ddd; padding: 8px;padding-top: 12px;padding-bottom: 12px; text-align: left; background-color: #424658; color: white;"><b>Col</b></th>
                <th style="font-size: 14px ; face:san-serif; border: 1px solid #ddd; padding: 8px;padding-top: 12px;padding-bottom: 12px; text-align: left; background-color: #424658; color: white;"><b>Status</b></th>
                <th style="font-size: 14px ; face:san-serif; border: 1px solid #ddd; padding: 8px;padding-top: 12px;padding-bottom: 12px; text-align: left; background-color: #424658; color: white;"><b>Default</b></th>
               <th style="font-size: 14px ; face:san-serif; border: 1px solid #ddd; padding: 8px;padding-top: 12px;padding-bottom: 12px; text-align: left; background-color: #424658; color: white;"><b>Entry By</b></th>
                <th style="font-size: 14px ; face:san-serif; border: 1px solid #ddd; padding: 8px;padding-top: 12px;padding-bottom: 12px; text-align: left; background-color: #424658; color: white;"><b>Entry Time</b></th>
   ...
   // String user=request.getParameter("username");
      ...
      // System.out.println("user : "+session.getAttribute("User"));
       ...
       int i=1;
       String sql = "select * from smartgrid.t_dispmapping where username='"+username+"'";
       ...
       while(rs4.next()){	
     	  ...
     	  user=rs4.getString("username");
     	  row=rs4.getString("row");
     	  colval=rs4.getString("colval");
     	  gridstatus=rs4.getString("gridstatus");
     	 defaultgrid=rs4.getString("defaultgrid");
     	  entryby=rs4.getString("entryby");
     	  updatetime1=rs4.getString("updatetime");
     	  gridname=rs4.getString("gridname");

     	  
     	  
     	   updatetime = new SimpleDateFormat("dd-MMM-yyyy HH:mm")
...
%>   	
			<tr>	
							<td style="font-size: 13px ; face:san-serif;" align="right"><%=i%></td>
								<td style="font-size: 13px ; face:san-serif;" align="left"><%=user %></td>
								
								<td style="font-size: 13px ; face:san-serif;" align="left"><div class="dropdown" style="color:#428bca ;" > <%=gridname %><div class="dropdown-content">
    							<a href="GridModify.jsp?gridname=<%=gridname %>&status=<%=StatusUpdate%>">Make Default Grid</a>
    							<a href="GridModify.jsp?gridname=<%=gridname %>&status=<%=StatusDelete%>">Delete Grid</a>
  								</div>
								</div></td>
								...
								<td style="font-size: 13px ; face:san-serif;" align="right"><%=row %></td>
								<td style="font-size: 13px ; face:san-serif;" align="right"><%=colval %></td>
								<td style="font-size: 13px ; face:san-serif;" align="left"><%=gridstatus %></td>
								<td style="font-size: 13px ; face:san-serif;" align="left"><%=defaultgrid %></td>
								<td style="font-size: 13px ; face:san-serif;" align="left"><%=entryby %></td>
								<td style="font-size: 13px ; face:san-serif;" align="right"><%=updatetime %></td>
