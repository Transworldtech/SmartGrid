	        ...
	        buttons: [
	        	
	        	{
	        		...
	        		buttons: [
	        			{
	                        extend: 'excel',
	                        title: 'Default Schedule Location Wise Report',
	                        },
	                    {
	                        extend: 'pdf',
	                        title: 'Default Schedule Location Wise Report',
...
<font id="head1" name="head1" face="san-serif" color="#333" size="4"><b>Default Schedule Report</b></font>
 ...
 <div id="head" name="head" class="form" align="center" style="font-size: 16px;">
<font id="head1" name="head1" face="san-serif" color="#333" size="3"><b>Default Schedule Location Wise Report</b></font>
</div>
...
<table id="example" class="display" style="width:100%" cellspacing="0" >
        <thead>
            <tr>
            	...
            	<th style="font-size: 14px ; face:san-serif; border: 1px solid #ddd; padding: 8px;padding-top: 12px;padding-bottom: 12px; text-align: left; background-color: #424658; color: white;"><b>Pole Id</b></th>
      ...
      String snapdatetime= "",poleid="",location="";
       ...
       while(rs3.next()){	
      	 					unitid1=rs3.getString("UnitID");

 String sql1 = "select * from  smartgrid.t_defaultschedule1 where poleid='"+unitid1+"' order by UpdateDateTime desc";
...
%>   	
			...
			<tr>	
							...
							<td style="font-size: 13px ; face:san-serif;" align="left"><%=poleid%></td>
							<td style="font-size: 13px ; face:san-serif;" align="left"><a href="CreateDefaultScheduleReport.jsp?schname1=<%=schname%>"><%=schname%></td>
