...
<title>Default AD Play Report</title>
...
<font id="head1" name="head1" face="san-serif" color="#333" size="4"><b>Default Schedule Report</b></font>
 ...
 <div id="head" name="head" class="form" align="center" style="font-size: 16px;">
<font id="head1" name="head1" face="san-serif" color="#333" size="3"><b>Default AD Play Report</b></font>
</div>
...
<table id="example" class="display" style="width:100%" cellspacing="0" >
        <thead>
            <tr>
                ...
                <th style="font-size: 14px ; face:san-serif; border: 1px solid #ddd; padding: 8px;padding-top: 12px;padding-bottom: 12px; text-align: left; background-color: #424658; color: white;"><b>Duration</b></th>
                <th style="font-size: 14px ; face:san-serif; border: 1px solid #ddd; padding: 8px;padding-top: 12px;padding-bottom: 12px; text-align: left; background-color: #424658; color: white;"><b>Played Date Time</b></th>
...
/*       String entryby="";
      ...
      if(dateStart==null)
      { 
    	   sql1 = "select vehicleRegNum,fileName,mediaType,duration,dispStartTime from smartgrid.t_AdPlayed where dispStartTime>='"+date11+"' and dispStartTime<='"+date22+"' order by dispStartTime desc";

    	  }else
    	  {
       	   sql1 = "select vehicleRegNum,fileName,mediaType,duration,dispStartTime from smartgrid.t_AdPlayed where dispStartTime>='"+date1+"' and dispStartTime<='"+date2+"' order by dispStartTime desc";
 ...
 while(rs4.next()){	
	 ...
	 durationdemo=rs4.getString("duration");
...
%>   	
			...
			<tr>	
			    	...
			    	<a href="#!" onclick="showFTPImage('<%=fileNamedemo%>');"><img  src="http://twtech.in/SmartGrid/Media/<%=fileNamedemo%>" width="50" height="50" /></a>
							...
							<%-- <td style="font-size: 13px ; face:san-serif;" align="left"><%=mediaTypedemo%></td>
							 --%><td style="font-size: 13px ; face:san-serif;" align="right"><%=durationdemo%></td>
